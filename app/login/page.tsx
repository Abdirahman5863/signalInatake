  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo:`https://leadvett.com/auth/callback?next=/dashboard`,
        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600">
              Sign in to access your clinical lead breakdowns, automated DM scripts, 
              and rule-based qualification system.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-4">
              <div className="rounded-xl bg-[#b5944b]/10 p-3 flex-shrink-0">
                <Zap className="h-6 w-6 text-[#b5944b]" />
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  No more reading paragraphs. Get instant Gold/Silver/Bronze decisions.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="rounded-xl bg-[#b5944b]/10 p-3 flex-shrink-0">
                <BarChart3 className="h-6 w-6 text-[#b5944b]" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">
                  Rule Engine
                ...
                <p className="text-sm text-gray-600">
                  See exactly why each badge was assigned with transparent breakdown.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="rounded-xl bg-[#b5944b]/10 p-3 flex-shrink-0">
                <Clock className="h-6 w-6 text-[#b5944b]" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">
                  Save 15 Hours/Week
                ...
                <p className="text-sm text-gray-600">
                  Stop wasting time on bad calls. Focus on Gold leads only.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-gray-200">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-[#b5944b]">127</div>
                <div className="text-xs text-gray-600">Agencies</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#b5944b]">1,905</div>
                <div className="text-xs text-gray-600">Hours Saved</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#b5944b]">83x</div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-600">
              Sign in to continue qualifying leads automatically
            </p>
          </div>
