...
export default function LeadVettLanding() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "A contact form just collects data. LeadVett scores every lead in 10 seconds and tells you exactly what to do — book the call, nurture them, or move on. It's a decision engine, not a form."
    },
    {
  ...
  return (
    <div style={{
      ...
      background: S.cream, color: S.dark, overflowX: "hidden", fontSize: 16, lineHeight: 1.6
    }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-dark {
          ...
          background: #0D0D0D; color: #fff; border: none; padding: 14px 28px;
          border-radius: 12px; font-size: 15px; font-weight: 600; cursor: pointer;
          text-decoration: none; transition: background 0.15s; font-family: inherit; white-space: nowrap;
        }
        .btn-dark:hover { background: #C9920A; }
        .btn-outline {
          display: inline-flex; align-items: center; justify-content: center; gap: 8px;
          background: transparent; color: #0D0D0D; border: 1.5px solid #D0C8B8;
          padding: 14px 28px; border-radius: 12px; font-size: 15px; font-weight: 600;
          cursor: pointer; text-decoration: none; transition: all 0.15s; font-family: inherit; white-space: nowrap;
        }
        ...
        .verdict-gold { background: #F0FAF5; border: 1.5px solid #BBE4CC; border-radius: 14px; padding: 20px; }
        .verdict-bronze { background: #FFF7ED; border: 1.5px solid #FED7AA; border-radius: 14px; padding: 20px; }
        ...
        .faq-btn {
          ...
          color: #0D0D0D; text-align: left; gap: 16px;
        }
        .faq-ans { overflow: hidden; transition: max-height 0.3s ease; }
        .step-num {
          width: 36px; height: 36px; border-radius: 50%; background: #0D0D0D; color: #C9920A;
          display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700; flex-shrink: 0;
        }
        .pill-green {
          display: inline-flex; align-items: center; gap: 7px; background: #F0FAF5;
          border: 1px solid #BBE4CC; border-radius: 100px; padding: 5px 14px;
        ...
        @media (max-width: 640px) {
          ...
          .h1s { font-size: 36px !important; letter-spacing: -1.5px !important; }
          .h2s { font-size: 26px !important; letter-spacing: -1px !important; }
          .pts { padding-top: 96px !important; }
        }
        @media (min-width: 641px) { .show-mob { display: none !important; } }
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 60 }}>
          <Link href="/" style={{ textDecoration: "none" }}>
            <span className="hd" style={{ fontSize: 20, fontWeight: 900, color: S.dark, letterSpacing: -0.5 }}>
          ...
          <div className="hide-mob" style={{ display: "flex", gap: 28, alignItems: "center" }}>
            ...
            <Link href="/signup" className="btn-dark" style={{ padding: "9px 20px", fontSize: 14 }}>Start free trial</Link>
          </div>
        ...
        {menuOpen && (
          <div className="show-mob" style={{ background: S.cream, borderTop: `1px solid ${S.border}`, padding: "16px 24px", flexDirection: "column", gap: 16, display: "none" }}>
            ...
            <Link href="/signup" className="btn-dark full" onClick={() => setMenuOpen(false)}>Start free trial</Link>
          </div>
        )}
      </nav>

      {/* HERO */}
      <section className="pts" style={{ paddingTop: 120, paddingBottom: 72, padding: "120px 24px 72px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>

          <div className="fu" style={{ marginBottom: 24 }}>
            <span className="pill-green">
              <span style={{ width: 6, height: 6, background: "#16A34A", borderRadius: "50%", animation: "pulse 2s infinite" }} />
              AI-powered lead qualification for agencies
            </span>
          </div>

          <h1 className="hd fu d1 h1s" style={{
            fontSize: "clamp(40px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.05,
            letterSpacing: -2.5, color: S.dark, marginBottom: 20
          }}>
            Know which leads<br />are worth your time.
          </h1>

          <p className="fu d2" style={{ fontSize: "clamp(16px, 2.5vw, 19px)", color: S.muted, lineHeight: 1.65, maxWidth: 520, margin: "0 auto 32px" }}>
            LeadVett scores every inbound lead in <strong style={{ color: S.dark }}>10 seconds</strong> before
            they touch your calendar. Gold means book the call. Bronze means move on.
          </p>

          <div className="fu d3 stack" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 14 }}>
            <Link href="/signup" className="btn-dark full" style={{ fontSize: 16, padding: "16px 32px" }}>
              Start free — 3 days, no card <ArrowRight size={17} />
            </Link>
            <Link href="#how-it-works" className="btn-outline full" style={{ fontSize: 16, padding: "16px 32px" }}>
              See how it works
            </Link>
          </div>

          <p className="fu d4" style={{ fontSize: 13, color: "#AAA" }}>
            3-day free trial · No credit card · $49/month after
          </p>

          {/* Real app preview */}
          <div className="fu d5" style={{ marginTop: 56 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 20, border: `1px solid ${S.border}`, overflow: "hidden", boxShadow: "0 2px 40px rgba(0,0,0,0.06)" }}>
              ...
              <div style={{ padding: "20px" }}>
                <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase", color: "#AAA", marginBottom: 14 }}>Lead Pipeline</p>
                <div className="verdict-gold" style={{ marginBottom: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8, marginBottom: 8 }}>
                    ...
                    <span style={{ background: "#16A34A", color: "#fff", fontSize: 12, fontWeight: 600, padding: "6px 14px", borderRadius: 8 }}>View Full Analysis →</span>
                  </div>
                ...
                <div className="verdict-bronze">
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8, marginBottom: 8 }}>
                    ...
                    <span style={{ background: S.orange, color: "#fff", fontSize: 12, fontWeight: 600, padding: "6px 14px", borderRadius: 8 }}>View Full Analysis →</span>
                  </div>
                  <p style={{ fontSize: 13, color: "#374151", fontStyle: "italic", marginBottom: 8 }}>"This person may not be worth a call right now due to low budget and vague intent."</p>
      ...
      <section style={{ background: S.dark, padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 className="hd h2s" style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 900, letterSpacing: -2, color: "#fff", marginBottom: 14 }}>
          ...
          <div style={{ background: "#111", borderRadius: 16, border: "1px solid #1A1A1A", padding: "32px 24px", marginBottom: 32 }}>
            ...
            <div className="g1" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24, textAlign: "center" }}>
              {[
                ...
                <div key={item.label}>
                  <div className="hd" style={{ fontSize: "clamp(36px, 5vw, 52px)", fontWeight: 900, color: item.color, lineHeight: 1, letterSpacing: -2 }}>{item.n}</div>
            ...
            <div style={{ borderTop: "1px solid #1A1A1A", marginTop: 28, paddingTop: 20, textAlign: "center" }}>
              <p style={{ color: "#666", fontSize: 15 }}>
                At $150/hr — that's <strong style={{ color: S.gold }}>$1,650 lost this week alone.</strong>
              </p>
            </div>
          </div>
      ...
      <section id="how-it-works" style={{ padding: "80px 24px", background: S.cream }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            <h2 className="hd h2s" style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 900, letterSpacing: -2 }}>
              Setup in 5 minutes.<br />Works forever.
            </h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
            {[
              { n: "01", title: "Create your qualification form", desc: "Pick 3–5 questions about budget, timeline, and decision authority. Use our template or build your own. No code needed.", note: "Ready-to-use templates included." },
              { n: "02", title: "Share your LeadVett link", desc: "Put it in your Instagram bio, ManyChat flow, email signature, or wherever you currently send Calendly links.", note: "One link. Works everywhere." },
              { n: "03", title: "Get a verdict in 10 seconds", desc: "Every submission gets scored instantly — Gold, Silver, or Bronze — with reasoning, risks, and a pre-written outreach script.", note: "Book the right people. Ignore the rest." },
            ].map(step => (
              <div key={step.n} style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
                <div className="step-num">{step.n}</div>
                <div>
                  <h3 className="hd" style={{ fontSize: 20, fontWeight: 800, marginBottom: 8, letterSpacing: -0.5 }}>{step.title}</h3>
      ...
      <section style={{ background: "#F5F3EF", padding: "72px 24px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <h2 className="hd h2s" style={{ fontSize: "clamp(26px, 4vw, 44px)", fontWeight: 900, letterSpacing: -2, marginBottom: 12 }}>
              Not just a score.<br />A complete decision.
            </h2>
            <p style={{ color: S.muted, fontSize: 17, maxWidth: 440, margin: "0 auto" }}>
              Every Gold lead comes with exact reasoning, risks to watch, and a ready-to-send script.
            </p>
          </div>
          <div style={{ background: "#fff", borderRadius: 20, border: `1px solid ${S.border}`, overflow: "hidden", boxShadow: "0 2px 24px rgba(0,0,0,0.05)" }}>
            <div style={{ padding: "24px 24px 0" }}>
              <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase", color: "#AAA", marginBottom: 16 }}>AI Verdict</p>
              ...
              <div style={{ background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: 12, padding: "16px 20px", marginBottom: 16, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            ...
            <div style={{ padding: "0 24px 24px" }}>
              <div style={{ borderTop: `1px solid ${S.border}`, paddingTop: 16, marginBottom: 12 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    ...
                    <div key={r.label} style={{ background: r.positive ? S.greenBg : "#FEF2F2", border: `1px solid ${r.positive ? S.greenBorder : "#FECACA"}`, borderRadius: 10, padding: "12px 16px", display: "flex", alignItems: "center", gap: 12 }}>
                      {r.positive ? <Check size={15} color={S.green} /> : <X size={15} color={S.red} />}
                      <span style={{ flex: 1, fontSize: 14, color: S.dark }}>{r.label}</span>
                      <span style={{ fontSize: 12, fontWeight: 700, padding: "2px 10px", borderRadius: 100, background: r.positive ? "#DCFCE7" : "#FEE2E2", color: r.positive ? "#15803D" : S.red }}>{r.pts}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div style={{ background: "#F8F8F8", borderRadius: 12, padding: "16px 20px" }}>
                ...
                <p style={{ fontSize: 13, color: S.muted, fontStyle: "italic", lineHeight: 1.6 }}>
                  "Hi [Name], I noticed you're looking to move forward within 1-2 weeks with a budget of $5k-$10k. Since you're the decision-maker, let's schedule a quick call..."
                </p>
              </div>
            </div>
          </div>
      ...
      <section style={{ background: S.dark, padding: "64px 24px" }}>
        <div className="g1" style={{ maxWidth: 800, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 40, textAlign: "center" }}>
          {[
            { val: "10", unit: "sec", label: "To score every lead" },
            { val: "15", unit: "hrs", label: "Saved per week on average" },
            { val: "3", unit: "day", label: "Free trial — no card needed" },
          ].map(s => (
            <div key={s.label}>
              <div className="hd" style={{ fontSize: "clamp(48px, 7vw, 64px)", fontWeight: 900, color: S.gold, lineHeight: 1, letterSpacing: -3 }}>
      ...
      {/* TESTIMONIAL — only Barun (real) */}
      <section style={{ padding: "80px 24px", background: S.cream }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <h2 className="hd h2s" style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 900, letterSpacing: -2, marginBottom: 10 }}>What early users say</h2>
          </div>
          <div style={{ background: "#fff", border: `1px solid ${S.border}`, borderRadius: 20, padding: "32px", boxShadow: "0 2px 20px rgba(0,0,0,0.04)" }}>
            <div style={{ display: "flex", gap: 2, marginBottom: 16 }}>
              {[...Array(5)].map((_, i) => (
                <svg key={i} width="14" height="14" viewBox="0 0 24 24" fill="#C9920A"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
              ))}
            </div>
            <p style={{ color: "#374151", fontSize: 16, lineHeight: 1.75, marginBottom: 24, fontStyle: "italic" }}>
              "Tested the product overall — impressed. Congrats on the launch. The AI verdict is genuinely useful and the scoring makes sense. Would save agency owners a lot of time. I'd love for the ability to host the form inside my own website."
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ width: 42, height: 42, borderRadius: "50%", background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", color: "#1E40AF", fontSize: 14, fontWeight: 700, flexShrink: 0 }}>BP</div>
              <div>
                <p style={{ fontWeight: 600, fontSize: 15 }}>Barun P.</p>
                <p style={{ fontSize: 13, color: S.muted }}>Founder, shipfast.ai — tested LeadVett on launch</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" style={{ padding: "80px 24px", background: "#F5F3EF" }}>
        <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="hd h2s" style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 900, letterSpacing: -2, marginBottom: 40 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: `2px solid ${S.dark}`, padding: "40px 32px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ marginBottom: 28 }}>
              <div className="hd" style={{ fontSize: 64, fontWeight: 900, color: S.dark, lineHeight: 1, letterSpacing: -3 }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 20, marginTop: 18, flexWrap: "wrap" }}>
              {[{ icon: Shield, text: "No credit card" }, { icon: Zap, text: "Active in 5 min" }, { icon: Clock, text: "Cancel anytime" }].map(({ icon: Icon, text }) => (
      ...
      <section style={{ padding: "80px 24px", background: S.cream }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          <h2 className="hd h2s" style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 900, letterSpacing: -2, marginBottom: 40, textAlign: "center" }}>Questions</h2>
          <div>
            {faqs.map((faq, i) => (
      ...
      <section style={{ background: S.dark, padding: "96px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <h2 className="hd h2s" style={{ fontSize: "clamp(32px, 6vw, 60px)", fontWeight: 900, letterSpacing: -3, color: "#fff", lineHeight: 1.05, marginBottom: 18 }}>
      ...
      <footer style={{ background: "#050505", padding: "40px 24px", borderTop: "1px solid #111" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="stack" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
            <span className="hd" style={{ fontSize: 18, fontWeight: 900, color: "#fff" }}>
              Lead<span style={{ color: S.gold }}>Vett</span>
            </span>
